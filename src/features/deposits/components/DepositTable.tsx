...
export function DepositTable() {
    ...
    const total = useMemo(() => sumMoney(deposits.map((deposit) => deposit.amount)), [deposits]);
                    ...
                    <DataTable
                        columns={[
                            ...
                            },
                            {
                                ...
                                header: 'Date',
                                cell: (deposit) => (
                                    <span className="whitespace-nowrap">{formatDate(deposit.transactionDate)}</span>
                                ),
                            },
                            {
                                key: 'method',
                                header: 'Method',
                                cell: (deposit) => (
                                    <Badge variant="secondary">{PAYMENT_METHOD_LABELS[deposit.paymentMethod]}</Badge>
                                ),
                            },
                            {
                                key: 'reference',
