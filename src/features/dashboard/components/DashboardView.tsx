...
export function DashboardView() {
    ...
    if (cycleError)
        return (
            <ErrorState
                error={cycleError}
                title="Couldn't load billing cycles"
            />
        );
            ...
            {dashboardQuery.error ? (
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                    ...
                    <StatCard
                        label="Grocery cost"
                        value={
                            <MoneyDisplay value={dashboard?.totalGroceryCost} />
                        }
                        icon={ShoppingBasket}
                    ...
                    <StatCard
                        ...
                        value={
                            <MoneyDisplay value={dashboard?.sharedExpenses} />
                        }
                        icon={Receipt}
                    ...
                    <StatCard
                        ...
                        value={
                            <MoneyDisplay value={dashboard?.totalDeposits} />
                        }
                        icon={Banknote}
