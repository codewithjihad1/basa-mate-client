...
import { CreateCycleButton } from "@/features/settings/components/CreateCycleDialog";
...
} from "@/store/api/endpoints/cycleApi";
import {
...
export function SettlementActions({
    ...
    const [confirming, setConfirming] = useState<
        "close" | "generate" | "finalize" | "reopen" | null
    >(null);
    ...
    return (
        <>
            ...
            <ConfirmDialog
                ...
                onConfirm={() =>
                    run(() => closeCycle(scope).unwrap(), "Cycle closed")
                }
            />
            ...
            <ConfirmDialog
                ...
                onConfirm={() =>
                    run(
                        () => generateSettlement(scope).unwrap(),
            ...
            <ConfirmDialog
                ...
                onConfirm={() =>
                    run(
                        () => finalizeSettlement(scope).unwrap(),
            ...
            <ConfirmDialog
                ...
                description={
                    <div className="space-y-3">
                        <p>
                            Meals, expenses and deposits become editable again,
                            and any settlement is marked as recalculating.
                        </p>
